...
const questionsData = [
    {
        ...
        text: "The network administrator is not getting the desired results. Which set of configurations resolves this issue?",
        options: [
            { letter: "A", text: "B." },
            { letter: "C", text: "D." },
            { letter: "D", text: "Section: (none) Explanation Explanation/Reference:" },
        ],
        correct: ["D"],
        isMultiple: false,
        explanation: ""
    },
    {
        id: 2,
        type: "multiple-choice",
        text: "How is the LDP router ID used in an MPLS network?",
        options: [
            { letter: "A", text: "The force keyword changes the router ID to the specified address without causing any impact." },
            { letter: "B", text: "It not configured, the operational physical interface is chosen as the router ID even it a loopback is configured." },
            { letter: "C", text: "The MPLS LDP router lD must match the ISP router ID." },
            { letter: "D", text: "The loopback with the highest IP address is selected as the router ID." },
            { letter: "D", text: "Section: (none) Explanation Explanation/Reference:" },
        ],
        correct: ["D"],
        isMultiple: false,
    ...
    },
    {
        id: 3,
        type: "multiple-choice",
        text: "What are the two reasons for RD and VPNv4 addresses in an MPLS Layer 3 VPN? (Choose two.)",
        options: [
            { letter: "A", text: "RD is prepended to each prefix to make routes unique." },
            { letter: "B", text: "VPN RT communities are used to identify customer unique routes." },
            { letter: "C", text: "When the PE redistributes customer routes into MP-BGP, they must be unique." },
            { letter: "D", text: "They are on a CE device to use for static configuration." },
            { letter: "E", text: "They are used for a BGP session with the CE device." },
            { letter: "B", text: "Section: (none) Explanation Explanation/Reference:" },
        ],
        correct: ["A", "B"],
        isMultiple: true,
        explanation: ""
    },
    {
        id: 4,
        type: "multiple-choice",
        text: "Which two features are required for MPLS forwarding on which types of routers? (Choose two.)",
        options: [
            { letter: "A", text: "LDP on PE and core routers" },
            { letter: "B", text: "CEF on PE and CE reuters" },
            { letter: "C", text: "LDP on PE and CE routers" },
            { letter: "D", text: "MPLS on PE and core routers" },
            { letter: "E", text: "MPLS on CE and core routers" },
            { letter: "D", text: "Section: (none) Explanation Explanation/Reference:" },
        ],
        correct: ["A", "D"],
        isMultiple: true,
    ...
    },
    {
        ...
        text: "Refer to the exhibit. An engineer is trying to block the route to 192.168.2.2 from the routing table by using the configuration that is shown. The route is still present in the routing table as an OSPF route. Which action blocks the route?",
        options: [
            { letter: "A", text: "Use an extended access list instead of a standard access list." },
            { letter: "B", text: "Use a prefix list instead of an access list in the route man." },
            { letter: "C", text: "Add this statement to the route map: routeamap RM-OSPF-DL deny 20." },
            { letter: "D", text: "Change sequence 10 in the route-map command from permit to deny." },
            { letter: "D", text: "Section: (none) Explanation Explanation/Reference:" },
        ],
        correct: ["D"],
        isMultiple: false,
    ...
    },
    {
        ...
        type: "multiple-choice",
        image: "images/page5_img1.jpeg",
        text: "Refer to the exhibit. A network administrator added one router in the Cisco DNA Center and checked its discovery and health from the Network Health Dashboard. The network administrator observed that the router is still showing up as unmonitored. What must be configured on the router to mount it in the Cisco DNA Center?",
        options: [
            { letter: "A", text: "Configure router with routing to reach Cisco DNA Center." },
            { letter: "B", text: "Configure router with SNMPv2c or SNMPv3 traps." },
            { letter: "C", text: "Configure router with NetFlow data." },
            { letter: "D", text: "Configure router with the telemetry data." },
            { letter: "D", text: "Section: (none) Explanation Explanation/Reference:" },
        ],
        correct: ["D"],
        isMultiple: false,
    ...
    },
    {
        ...
        text: "Referto the exhibit. Which action resolves intermittent connectivity observed with the SNMP trap packets?",
        options: [
            { letter: "A", text: "Add one new entry in the ACL 120 to permit the UDP port 161." },
            { letter: "B", text: "Add a new class map to match TCP traffic." },
            { letter: "C", text: "Increase the CIR of the mgmt class map." },
            { letter: "D", text: "Decrease the committed burst size of the mgmt class map." },
            { letter: "C", text: "Section: (none) Explanation Explanation/Reference:" },
        ],
        correct: ["C"],
        isMultiple: false,
        explanation: ""
    },
    {
        ...
        type: "multiple-choice",
        image: "images/page6_img1.jpeg",
        text: "Refer to the exhibit. The control plane is heavily impacted after the CoPP configuration is applied to the router. Which command removal lessens the impact on the control plane?",
        options: [
            { letter: "A", text: "B." },
            { letter: "C", text: "D." },
            { letter: "C", text: "Section: (none) Explanation Explanation/Reference:" },
    ...
    },
    {
        ...
        text: "Refer to the exhibit. Packets arriving from source 209.165.200.215 must be sent with the precedence bit set to 1, and packets arriving from source 209.165.200.216 must be sent with the precedence bit set to 5. Which action resolves the issue?",
        options: [
            { letter: "A", text: "set ip precedence critical in route-map Texas permit 20" },
            { letter: "B", text: "set ip precedence immediate in route-map Texas permit 10" },
            { letter: "C", text: "set ip precedence critical in route-map Texas permit 10" },
            { letter: "D", text: "set ip precedence priority in route-map Texas permit 20" },
            { letter: "A", text: "Section: (none) Explanation Explanation/Reference:" },
        ],
        correct: ["A"],
        isMultiple: false,
        explanation: ""
    },
    {
        id: 10,
        type: "multiple-choice",
        text: "What is a limitation of IPv6 RA Guard?",
        options: [
            { letter: "A", text: "Packets that are dropped by IPv6 RA Guard cannot be spanned." },
            { letter: "B", text: "It cannot be configured on a switch port interface in the ingress direction" },
            { letter: "C", text: "It is not supported in hardware when TCAM is programmed." },
            { letter: "D", text: "It does not offer protection in environments where IPv6 traffic is tunneled." },
            { letter: "D", text: "Section: (none) Explanation Explanation/Reference:" },
        ],
        correct: ["D"],
        isMultiple: false,
    ...
    },
    {
        ...
        options: [
            { letter: "A", text: "B." },
            { letter: "C", text: "D." },
            { letter: "E", text: "Correct Answer: BD" },
        ],
        correct: ["B", "D"],
        isMultiple: true,
        explanation: ""
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "E", text: "Section: (none) Explanation Explanation/Reference:" },
        ],
        correct: ["C", "E"],
        isMultiple: true,
        explanation: ""
    ...
    },
    {
        ...
        options: [
            { letter: "A", text: "B." },
            { letter: "C", text: "D." },
            { letter: "E", text: "Correct Answer: CD" },
        ],
        correct: ["C", "D"],
        isMultiple: true,
        explanation: ""
    ...
    },
    {
        ...
        options: [
            { letter: "A", text: "B." },
            { letter: "C", text: "D." },
            { letter: "E", text: "Correct Answer: DE" },
        ],
        correct: ["D", "E"],
        isMultiple: true,
        explanation: ""
    ...
    },
    {
        ...
        options: [
            { letter: "A", text: "B." },
            { letter: "C", text: "D." },
            { letter: "E", text: "Correct Answer: BC" },
        ],
        correct: ["B", "C"],
        isMultiple: true,
        explanation: ""
    ...
    },
    {
        id: 176,
        type: "multiple-choice",
        text: "How many labels are present in an MPLS Layer 3 packet traversing through the network without traffic engineering?",
        options: [
            { letter: "A", text: "4" },
            { letter: "B", text: "1" },
            { letter: "C", text: "3" },
    ...
    },
    {
        id: 213,
        type: "multiple-choice",
        image: "images/page109_img1.jpeg",
    ...
    },
    {
        id: 216,
        type: "multiple-choice",
        image: "images/page110_img1.jpeg",
    ...
    },
    {
        id: 217,
        type: "multiple-choice",
        image: "images/page111_img1.jpeg",
    ...
    },
    {
        id: 243,
        type: "multiple-choice",
        image: "images/page124_img1.jpeg",
    ...
    },
    {
        id: 249,
        type: "multiple-choice",
        image: "images/page127_img1.jpeg",
    ...
    },
    {
        id: 255,
        type: "multiple-choice",
        image: "images/page130_img1.jpeg",
    ...
    },
    {
        id: 281,
        type: "multiple-choice",
        image: "images/page143_img1.jpeg",
    ...
    },
    {
        id: 305,
        type: "multiple-choice",
        image: "images/page155_img1.jpeg",
    ...
    },
    {
        id: 322,
        type: "multiple-choice",
        text: "Which lP precedence value does BFD use to prioritize traffic within an infrastructure device?",
        options: [
            { letter: "A", text: "6" },
            { letter: "B", text: "4" },
            { letter: "C", text: "5" },
    ...
    },
    {
        id: 327,
        type: "multiple-choice",
        image: "images/page166_img1.jpeg",
    ...
    },
    {
        id: 358,
        type: "multiple-choice",
        image: "images/page181_img1.jpeg",
    ...
    },
    {
        id: 367,
        type: "multiple-choice",
        image: "images/page186_img1.jpeg",
    ...
    },
    {
        id: 369,
        type: "multiple-choice",
        image: "images/page187_img1.jpeg",
    ...
    },
    {
        id: 371,
        type: "multiple-choice",
        image: "images/page188_img1.jpeg",
    ...
    },
    {
        id: 373,
        type: "multiple-choice",
        image: "images/page189_img1.jpeg",
    ...
    },
    {
        id: 375,
        type: "multiple-choice",
        image: "images/page190_img1.jpeg",
    ...
    },
    {
        id: 379,
        type: "multiple-choice",
        image: "images/page192_img1.jpeg",
    ...
    },
    {
        id: 381,
        type: "multiple-choice",
        image: "images/page193_img1.jpeg",
    ...
    },
    {
        ...
        options: [
            ...
            { letter: "D", text: "ECMF" },
            { letter: "E", text: "RSVP" },
            { letter: "E", text: "Section: (none) Explanation Explanation/Reference: Exam B" },
        ],
        correct: ["A", "E"],
        isMultiple: true,
        explanation: ""
    },
    {
        id: 1,
        type: "multiple-choice",
        text: "Drag and drop the descriptions from the left onto the IPv6 first hop security features on the right.Not all options are used. Select and Place: Correct Answer: Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 2,
        type: "multiple-choice",
        text: "Drag and drop the ICMPv6 neighbor discovery messages from the left onto the correct packet types on the right. Select and Place: Correct Answer:  Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 3,
        type: "multiple-choice",
        text: "Drag and drop the MPLS concepts from the left onto the descriptions on the right. Select and Place: Correct Answer: Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 4,
        type: "multiple-choice",
        text: "Drag and drop the MPLS VPN concepts from the left onto the correct descriptions on the right. Select and Place: Correct Answer:  Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 5,
        type: "multiple-choice",
        text: "Drag and drop the MPLS VPN device types from the left onto the definitions on the right. Select and Place: Correct Answer: Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 6,
        type: "multiple-choice",
        text: "Drag and drop the MPLS terms from the left onto the correct definitions on the right. Select and Place: Correct Answer:  Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 7,
        type: "multiple-choice",
        text: "Drag and drop the actions from the left into the correct order on the right to configure a policy to avoid following packet forwarding based on the normal routing path. Select and Place: Correct Answer: Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 8,
        type: "multiple-choice",
        text: "Drag and drop the IPv6 first hop security device rolesfrom the left onto the corresponding descriptions on the right. Select and Place: Correct Answer: Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 9,
        type: "multiple-choice",
        text: "Drag and drop the code snippets from the right onto the boxes in the configuration to establish the needed connection. Snippets may be used more than once. Select and Place: Correct Answer:  Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 10,
        type: "multiple-choice",
        text: "Drag and drop the IPv6 First-Hop Security features from the left onto the definitions on the right. Select and Place: Correct Answer: Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 11,
        type: "multiple-choice",
        text: "Drag and drop the LDP features from the left onto the decisions on the right. Select and Place: Correct Answer: Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 12,
        type: "multiple-choice",
        text: "Drag and drop the terminology from the left onto the corresponding definitions on the right. Select and Place: Correct Answer: Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 13,
        type: "multiple-choice",
        text: "Drag and drop the descriptions from the left onto the corresponding MPLS components on the right. Select and Place: Correct Answer: Section: (none) Explanation Explanation/Reference: Exam C",
        options: [
        ],
        correct: [],
        isMultiple: false,
    ...
    },
    {
        id: 1,
        type: "multiple-choice",
        text: "A. Correct Answer: A Section: (none) Explanation Explanation/Reference:",
        options: [
        ],
        correct: ["A"],
        isMultiple: false,
